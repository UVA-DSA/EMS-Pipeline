    ...
    def transcription_worker(self):
        while True:
            ...
            if whisper_config.mode == "whispercpp":
                # transcription = self.transcribe_with_whispercpp(self.transcription_queue.get())
                ...
                # print(self.get_longest_audio_chunk_to_transcribe())
                # print(len(self.get_longest_audio_chunk_to_transcribe()))
                # transcription = self.transcribe_with_huggingface(self.transcription_queue.get())
