...
class MainWindow(QWidget):
    ...
    def __init__(self, width, height):
        ...
        # Create a save state button in the window
        self.SaveButton = QPushButton('   Save State   ', self)
        self.SaveButton.move(int(1650 * DIM), int(20 * DIM))
        self.SaveButton.clicked.connect(self.SaveButtonClick)

        # Create a generate form button in the window
        self.GenerateFormButton = QPushButton('   Generate Form   ', self)
        self.GenerateFormButton.move(int(1500 * DIM), int(20 * DIM))
        ...
        #self.MsgBox.setLineWrapMode(QTextEdit.FixedPixelWidth)
        #self.MsgBox.setLineWrapColumnOrWidth(80*80)
    ...
    def SaveButtonClick(self):
        ...
        concept_extraction_text = str(self.NLPBox.toPlainText())
        protocol_text = str(self.ProtocolName.toPlainText())
        intervention_text = str(self.ActionBox.toPlainText())
    ...
    def StartButtonClick(self):
        ...
        # If Text File
            ...
            self.SpeechThread = StoppableThread(target = TextStream.TextSpeech, args=(self, SpeechToNLPQueue, str(text_fname),))
            self.SpeechThread.start()
        ...
        if(self.CognitiveSystemThread == None):
            print('CognitiveSystem Thread Started')
            self.CognitiveSystemThread = StoppableThread(target = CognitiveSystem.CognitiveSystem, args=(self, SpeechToNLPQueue,))
...
if __name__ == '__main__':
    ...
    # Set environment variable for Google Speech
