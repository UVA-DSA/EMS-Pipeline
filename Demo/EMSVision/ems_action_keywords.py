...
admin_epi = []
cardiac_monitor = ["Attaching Cardiac Monitor to a patient","A Cardiac monitor"]

# respiratory distress
resp_assist_ventilation_bvm_via_mask = ["Placing Oxygen mask on face","BVM Mask" ]
resp_nebulizer_therapy = ["Attaching a low volume nebulizer", "A Low volume Nebulizer"]
