...
from EMSAgent.Interface.default_sets import device, multi_graph, dataset
if dataset == 'EMS':
    from EMSAgent.Interface.default_sets import p_node, ungroup_p_node, EMS_DIR
elif dataset == 'MIMIC3':
    from EMSAgent.Interface.default_sets import ICD9_DIAG, ICD9_DIAG_GROUP, MIMIC_3_DIR
