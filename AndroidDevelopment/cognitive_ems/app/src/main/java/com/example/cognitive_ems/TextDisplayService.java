 ...
 */
    protected void objectFeedbackParser(String args) {
        try {
            ...
            for (String feedback : listObjects) {
                ...
                Integer minX = parseInt(feedback.substring(feedback.indexOf("[[") + 2, feedback.indexOf(",", feedback.indexOf("[["))));
                Integer minY = parseInt(feedback.substring(feedback.indexOf(",", feedback.indexOf("[[")) + 1, feedback.indexOf("]", feedback.indexOf("[["))));
                Integer maxX = parseInt(feedback.substring(feedback.indexOf("],[") + 3, feedback.indexOf(",", feedback.indexOf("],[") + 3)));
                Integer maxY = parseInt(feedback.substring(feedback.indexOf(",", feedback.indexOf("],[") + 4) + 1, feedback.indexOf("]]")));
