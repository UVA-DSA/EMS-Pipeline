...
def capture_audio(tflitemodel,input_details,output_details,blank,num_rnns,nstates,statesize, TranscriptQueue, ConformerSignalQueue):
...
def main(
    ...
    capture_audio(tflitemodel,input_details,output_details,blank,num_rnns,nstates,statesize, TranscriptQueue, ConformerSignalQueue)
