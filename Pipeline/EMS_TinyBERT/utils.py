...
from EMS_TinyBERT.default_sets import dataset, SAVE_RESULT_ROOT
if dataset == 'EMS':
    from EMS_TinyBERT.default_sets import p_node, group_p_dict, reverse_group_p_dict, ungroup_p_node, group_hier, ungroup_hier, p2hier
elif dataset == 'MIMIC3':
    from EMS_TinyBERT.default_sets import ICD9_DIAG
import re
