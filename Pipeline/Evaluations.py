...
from EMS_TinyBERT.default_sets import ungroup_p_node
import os
from time import sleep
import datetime
from EMS_TinyBERT.utils import get_precision_at_k, get_recall_at_k, get_r_precision_at_k, get_ndcg_at_k
...
if __name__ == '__main__':
    ...
    pipeline_config.evaluation = True
