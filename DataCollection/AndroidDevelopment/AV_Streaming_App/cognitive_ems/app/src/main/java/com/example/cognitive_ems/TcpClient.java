...
//    }
    ...
    public int sendImage(final ImageData image, SocketIOService client) {
        if (image != null) {
            ...
            base64String += "," + image.seq + "," + image.timestamp;
    ...
    public void run() {
        Log.d("Video TCP Client", "Executing run()");
        ...
        DatagramSocket datagramSocket = null;
            ...
            try {
                ...
                datagramSocket = new DatagramSocket(); // Create a UDP socket
                InetAddress serverAddr = InetAddress.getByName(SERVER_IP); // Convert the IP address string to InetAddress
