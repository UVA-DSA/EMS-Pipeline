...
video_path = 'video1792392526.mp4'
cap = cv2.VideoCapture(video_path)

csv_path = 'frameCSV.csv'
...
def save_clipped_csv(start_frame, end_frame):
    global csv_file, csv_path
    clipped_csv = csv_file.iloc[start_frame - 1:end_frame]
    clipped_csv.to_csv(csv_path, index=False)
...
while True:
    ...
    if key == 27:  # ESC key to exit
        ...
        save_clipped_csv(start_frame, end_frame)
        #break
